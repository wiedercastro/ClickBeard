<div class="wrapper">
    ...
    if(isset($_GET['busca']) && isset($_GET['nome'])){
        ...
        $busca = array('excluido = 0','id_cliente = '.$_SESSION['PL_USER']['id']); 
    }
    ...
    $dados = $pagination->createLinks(array('id', 'id_categoria','id_funcionario','data_cadastro', 'hora_atendi', 'status'), 'servicos', $busca, array('id'), array('DESC'), 20, 0, $pag, $return_page);
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
            <span class="pull-left" style="margin-right: 10px">Agendamento</span>
            </h1>
            <div class="pull-right">
                <a href="<?php echo PL_PATH_ADMIN; ?>/agendar_cadastro" class="btn btn-success ">
                    <div class="icon">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="alert" style="display: none" id="mensagem_retorno">
                            ...
                            <form action="javascript:void(0)" onsubmit="document.location = '<? echo PL_PATH_ADMIN; ?>/tarefas&busca='+$('#busca').val()+'&nome='+$('#nome').val(); return false;" method="get" enctype="multipart/form-data">
                                ...
                                <h4 class="col-xs-12" style="margin-top: 0">Buscar Agenda</h4>
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px" class="no-sort">Serviço</th>
                                        <th style="width: 300px" class="no-sort">Funcionário</th>
                                        <th style="width: 100px" class="no-sort">Dt. Atendimento</th>
